    ...
    return GetX<SystemController>(
      builder: (menuController) => AnimatedContainer(
        ...
        child: AnimatedOpacity(
            duration: const Duration(milliseconds: 300),
            opacity: menuController.menubarWidth.value == menuWidth ? 1 : 0,
                ...
                children: [
                  ...
                  for (App app in apps)
                    if (menubarAppsPackageNames!.contains(app.packageName))
                      if (appController.appStack.checkApp(app.packageName) !=
                          -1)
                        MenuIcon(
                            apps: appController.appStack[appController.appStack
                  ...
                  for (List<App> apps in appController.appStack)
                    if (!menubarAppsPackageNames!.contains(apps[0].packageName))
                      MenuIcon(apps: apps),
